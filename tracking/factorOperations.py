...
def joinFactors(factors: List[Factor]):
    ...
    for factor in factors:
        ...
        conditioned_sets.append(factor.conditionedVariables())
        
    all_conditioned = set(functools.reduce(lambda acc, x: acc.union(x), conditioned_sets, set()))
    conditioned = all_conditioned - unconditioned
    ...
    def eliminate(factor: Factor, eliminationVariable: str):
        ...
        for assignment in new_factor.getAllPossibleAssignmentDicts():
            ...
            for elim_var_value in factor.variableDomainsDict()[eliminationVariable]:
                ...
                extended_assignment[eliminationVariable] = elim_var_value
